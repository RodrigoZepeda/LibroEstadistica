...
Siguiendo la definición de @gelman2013bayesian , denotamos el conjunto de datos observados como la matriz (_base de datos_) de $\ell \times n$
$$
Z = \begin{pmatrix} 
...
Para más información sobre estadística circular puedes consultar @pewsey2013circular
