...
$$
para $A,B$ medibles. Una colección $\{ X_i \}_{i}$ de variables aleatorias es **completamente independiente** si para cualquier subcolección  $\{ X_{i_k} \}_{i_k}$ se tiene que:
$$
