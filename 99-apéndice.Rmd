...
```{r}
TeoremaCentralLimite(distribucion = runif, mu = 1/2, sigma = 1/12, 
...
### Ejercicio
Repite la programación del teorema del límite central pero ahora tomando las $X_k$ con distintas distribuciones siempre y cuando $X_k$ tenga media $\mu_k$ finita y las variables aleatorias satisfagan la [condición de Lindberg](https://en.wikipedia.org/wiki/Lindeberg%27s_condition) (una forma de hacerlo es teniendo varianzas finitas que no incrementan con la $k$). 
